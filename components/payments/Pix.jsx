    ...
    <div className="bonuses">
      <div className="main__container flex justify-between items-center">
        <div className="flex flex-col basis-[60%]">
          <h1 className="text-white">Discover Top-Rated Casinos Accepting Pix Payments for Quick and Secure Transactions</h1>
          <p className="text-white mt-5">Explore our curated list of premium casinos that support Pix as a payment option. Known for its speed and security, Pix is a go-to method for deposits and withdrawals among online casino enthusiasts worldwide. It offers the advantage of sidestepping traditional banking hassles and pesky geographical limits. If you haven&#39;t set up a Pix wallet yet, it&#39;s easy to do so—then you&#39;re all set to try your luck!</p>
          {/* <Subscribe /> */}
        </div>
