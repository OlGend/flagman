...
class Brand
{
    ...
    function read()
    {
        ...
        $query = "SELECT
            ...
            `Segment2`, `Первый приоритет`, `Trendsetting`, `Hottest`, `Quick Sign-Up`, `id_brand`, `Video`
        FROM
            " . $this->table_name;
...
function update()
{
    ...
    $query = "UPDATE
           ...
           `Quick Sign-Up` = :QuickSignUp, `id_brand` = :IdBrand, `Video` = :Video
           WHERE
    ...
    function create()
{
    ...
    :Segment2, :FirstPriority, :Trendsetting, :Hottest, :QuickSignUp, :IdBrand, :Video)";
